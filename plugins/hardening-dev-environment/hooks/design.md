...
- package.json Edit simulation reads disk for the existing file; if the file is modified between hook fire and tool execution (rare race), the comparison is stale
